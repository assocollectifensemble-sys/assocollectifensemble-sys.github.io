...
PAGES = [
    ...
    ("histoires.html", "/histoires", "Histoires de mariages — le carnet"),
    ("histoires/emma-fabien.html", "/histoires/emma-fabien",
     "Récit : Emma & Fabien, un mariage en 2CV dans l'Ouest"),
